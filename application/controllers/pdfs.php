...
// Establecemos el contenido para imprimir
        ...
        $correo = $this->Mdl_Usuarios->buscarUsuario($email);
        foreach($correo as $re)
        {
            $re = $fila['nombre_usuario'];
            $re = $fila['apellidos'];
            $re = $fila['email'];
            $re = $fila['password'];
            $re = $fila['telefono'];
            $re = $fila['calle'];
            $re = $fila['numero_exterior'];
            $re = $fila['numero_interior'];
            $re = $fila['colonia'];
            $re = $fila['referencia'];
            $re = $fila['codigo_postal'];
            $re = $fila['ciudad'];
            $re = $fila['estado'];
...
// Este método tiene varias opciones, consulte la documentación para más información.
        $nombre_archivo = utf8_decode("Usuario: ".$re.".pdf");
